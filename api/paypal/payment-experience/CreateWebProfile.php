...
$flowConfig->setBankTxnPendingUrl("http://www.spo-bit.com/");
...
$presentation->setLogoImage("http://www.spo-bit.com/public/images/logo_sm.png")
//	A label that overrides the business name in the PayPal account on the PayPal pages.
    ->setBrandName("SPO-BIT")
...
$webProfile->setName("SPO-BIT GOLD PURCHASE" . uniqid())
...
echo $createProfileResponse->getId();
